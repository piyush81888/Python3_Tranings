"""
Why object or Object Oriented Programming?

In this section,
1. Encapsulation: Keeping data and related methods together
2. Abstraction: Idea of writing methods inside class is to provide
                Abstraction where end-user of that class, JUST need
                to know what each method is doing AND
                NO-NEED to know how it is implemented/written
"""

print("DATA present inside 'str' class object:")
print("-"*20)
# -------------
